...
if __name__ == "__main__":
    ...
    df = pd.read_csv(
        "data/ml-10m/ratings.dat", sep="::", header=None, names=["user_id", "movie_id", "rating", "timestamp"]
    )
    ...
    # date_encoder = CategoryValueToSparseEncoder[pd.Timestamp](implicit_data_source.timestamp.dt.date.values)
    ...
    fm.fit(
        ...
        callback=callback,
        n_kept_samples=callback.n_iter - 5,
    )
